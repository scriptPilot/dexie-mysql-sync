...
Three steps to a running Demo App with two-way synchronization for tasks and files and with user management.
...
3. Open the **Demo App** at http://localhost:5173 in multiple browsers and play with the synchronization.
   ...
   Test the **user management**. Reigster, login, see how personal data is managed well, change the password, logout.
