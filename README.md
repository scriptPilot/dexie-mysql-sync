...
1. Install [Docker](https://www.docker.com/) and [Node.js](https://nodejs.org/), open the Terminal and copy paste:
...
2. Open the **Todo App** at http://localhost:5173 in multiple browsers and play with the synchronization.
3. Open **phpMyAdmin** at http://localhost:8080, login with `root`:`root` and take a look at the database.
